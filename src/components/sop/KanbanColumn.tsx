...
interface Props {
  ...
  getCustomerName: (projectId: string) => string;
  onCardClick: (sop: Tables<'sop_orders'>) => void;
}

export default function KanbanColumn({ id, title, color, items, getUserName, getProjectColor, getCustomerName, onCardClick }: Props) {
